...
# -*- coding: utf-8 -*-
"""
Accompanying blog: https://medium.com/codex/building-cool-applications-with-streamlit-and-snowflake-af1cafbc6964 
...
def exec_sql(sess, query):
    try:
        df=pd.read_sql(query,sess)
            ...
            st.error("Oops! " + str(query) + "error executing" + str(sys.exc_info()[0]) + "occurred.")
    else:
        return df
    return
...
def main():
    ...
    st.sidebar.info(
        ...
        "Here is documentation for [Snowflake](https://docs.snowflake.com/en/index.html) and [Streamlit](https://docs.streamlit.io/)"
